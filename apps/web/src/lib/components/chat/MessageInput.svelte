					...
					>
						...
						<div
							...
							class="flex-1 flex flex-col relative w-full shadow-lg rounded-3xl border {$temporaryChatEnabled
								...
								: ' border-gray-100/30 dark:border-gray-850/30 hover:border-gray-200 focus-within:border-gray-100 hover:dark:border-gray-800 focus-within:dark:border-gray-800'}  transition px-1 bg-white/10 dark:bg-gray-900/20 backdrop-blur-xl dark:text-gray-100"
												...
												>
													<button
														...
														class="{!(prompt === '' && files.length === 0) || uploadPending
															? 'bg-[var(--accent)] text-[var(--accent-foreground)] hover:opacity-90 shadow-accent '
															: 'text-white bg-gray-200 dark:text-gray-900 dark:bg-gray-700 disabled'} transition-all duration-200 rounded-full p-1.5 self-center active:scale-90"
														type="submit"
