		...
		<div class="flex flex-col md:flex-row w-full pt-1 pb-4">
			...
			>
				...
				{#if filteredSettings.length > 0}
					{#each filteredSettings as tabId (tabId)}
						...
						{:else if tabId === 'gabomagpt'}
						<button
							role="tab"
							aria-controls="tab-gabomagpt"
							aria-selected={selectedTab === 'gabomagpt'}
							class={`px-0.5 md:px-2.5 py-1 min-w-fit rounded-xl flex-1 md:flex-none flex text-left transition
							${selectedTab === 'gabomagpt'
								? ($settings?.highContrastMode ?? false)
									? 'dark:bg-gray-800 bg-gray-200'
									: ''
								: ($settings?.highContrastMode ?? false)
							...
							on:click={() => { selectedTab = 'gabomagpt'; }}
						>
							<div class="self-center mr-2">
							...
							<div class="self-center">GabomaGPT</div>
						</button>
					{:else if tabId === 'about'}
							<button
								role="tab"
			...
			<div class="flex-1 px-3.5 md:pl-0 md:pr-4.5 md:min-h-[42rem] max-h-[42rem]">
				...
				{:else if selectedTab === 'account'}
					...
					/>
				{:else if selectedTab === 'gabomagpt'}
					<div class="flex flex-col gap-6 overflow-y-auto max-h-full pr-1">
						...
						<!-- Info plan actuel -->
						<div>
							<h3 class="text-sm font-semibold mb-3">Mon plan</h3>
							<div class="rounded-xl border border-[var(--border)] p-4">
								<div class="flex items-center justify-between">
									<div>
										<div class="text-sm font-semibold" style="color: {PLANS[gabomaState.plan].color}">
									...
									<button
										class="rounded-xl px-4 py-2 text-xs font-semibold bg-[var(--accent)] text-[var(--accent-foreground)] transition-all duration-200 hover:opacity-90 active:scale-95"
						...
						<div class="text-center text-[10px] text-gray-500 pt-2">
							GabomaGPT — IA souveraine gabonaise<br/>
