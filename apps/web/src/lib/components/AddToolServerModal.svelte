				...
				>
					...
					{#if type === 'mcp'}
						...
						>
							...
							{$i18n.t(
								'MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the GabomaGPT team, making it the more reliable option for compatibility.'
							)}

							<a
								class="font-medium underline"
								href="https://docs.gabomagpt.com/features/mcp"
