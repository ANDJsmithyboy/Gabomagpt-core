...
:: -- Connexion Groq (OpenAI-compatible) --
SET OPENAI_API_BASE_URLS=https://api.groq.com/openai/v1
SET OPENAI_API_KEYS=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
SET GROQ_API_KEY=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
SET DEFAULT_MODELS=openai/gpt-oss-120b
